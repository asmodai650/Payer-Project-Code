...
namespace Novus.Payer1060
{
    ...
    public class PreSplit1060
    {
		...
		public PreSplit1060(RacerLoadJobReadOnlyProperties passedRacerLoadJobReadOnlyProperties)
        {
        ...
        public bool Execute()
        {
            _racerProps.LogWriter.Write(_jobID, "PreSplit1060 Begin", DateTime.Now.ToString());
            ...
            _racerProps.LogWriter.Write(_jobID, "PreSplit1060 End", DateTime.Now.ToString());
